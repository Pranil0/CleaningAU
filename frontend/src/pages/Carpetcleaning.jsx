...
<div className="max-w-4xl mx-auto px-6 pb-16">
  ...
  {[
    "Carpets add warmth and comfort to any home or workplace, but over time, dust, spills, and grime can get trapped deep within the fibers, leaving them dull and lifeless. Regular vacuuming only removes surface dirt, while hidden allergens, bacteria, and stains continue to linger beneath.",
    "Our professional carpet steam cleaning service goes beyond surface cleaning. Using high-powered steam extraction and eco-friendly solutions, we penetrate deep into carpet fibers to remove dirt, bacteria, and stubborn stains—restoring the freshness, softness, and vibrancy of your carpets.",
    "Regular carpet steam cleaning doesn’t just improve the appearance of your space; it also helps extend the life of your carpets, saving you from costly replacements."
  ].map((p, i) => (
  ...
  <h3 className="text-xl font-semibold mb-3">
    Our carpet steam cleaning service is designed to:
  </h3>
  <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
    {[
      "Remove tough stains, spills, and trapped dirt.",
      "Eliminate hidden bacteria, dust mites, and allergens.",
      "Revive the natural softness and color of your carpet.",
      "Extend the lifespan of your carpet with deep fiber care."
    ].map((li, i) => (
      ...
      <motion.div className="max-w-6xl mx-auto px-6 py-16">
        ...
        <motion.div className="grid md:grid-cols-3 gap-6" variants={staggerContainer} initial="hidden" whileInView="visible">
          {[gallery1, gallery2, gallery3].map((img, i) => (
            <motion.div key={i} className="rounded-2xl shadow-lg overflow-hidden aspect-square" whileHover={{ scale: 1.05, rotate: [0, 2, -2, 0] }} transition={{ duration: 0.4 }}>
